...
class LocationStampColor: UIViewController, ColorWheelDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let color = userDefaults.color(forKey: "LocTxtColor") {
    ...
    @IBAction func didTapSave(_ sender: UIButton) {
        userDefaults.set(colors, forKey: "LocTxtColor")
